...
const EmptyCart = () => {
  return (
    <div className="flex h-full w-full items-center justify-center bg-white p-6">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-5 rounded-2xl border-2 border-dashed border-black/20 py-24 text-center transition-all duration-300 hover:border-black/50 hover:bg-gray-50">
        {/* Icon: Muted gray/black */}
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-xs font-bold uppercase tracking-wider text-black/30">
